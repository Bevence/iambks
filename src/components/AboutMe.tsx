        ...
        <div className="text-center max-w-2xl max-md:max-w-md mx-auto">
          <div>
            <h2 className="text-gray-800 md:text-4xl text-3xl font-extrabold mb-4 md:!leading-[45px]">
              ...
              <span className="text-coral">Powering </span>
            ...
            <div className="grid sm:grid-cols-3 gap-6 items-center mt-12">
              <div className="flex flex-col items-center text-center">
                <h5 className="font-bold text-2xl text-coral mb-2">4+</h5>
                <p className="text-gray-600 text-sm font-semibold">
                  Years Experience
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <h5 className="font-bold text-2xl text-coral mb-2">15+</h5>
                <p className="text-gray-600 text-sm font-semibold">Projects</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <h5 className="font-bold text-2xl text-coral mb-2">5</h5>
            ...
            <div className="mt-12 flex gap-x-6 gap-y-4 justify-center max-sm:flex-col">
              <button
                type="button"
                className="bg-coral hover:bg-transparent hover:text-coral border border-coral transition-all text-white font-bold text-sm rounded px-6 py-3"
